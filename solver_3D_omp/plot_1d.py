...
q0_6=data0[6]  # ry1
q0_7=data0[7]  # ry2
q0_8=data0[8] +0.4   # temp
q0_9=data0[9]*0.15 +0.45  # gam
...
plt.plot(x0_1[:nmax], q0_6[:nmax], "o", color="cyan"       , markevery=20, markersize="10", markerfacecolor="white", zorder=-6)
plt.plot(x0_1[:nmax], q0_7[:nmax], "o", color="pink"       , markevery=20, markersize="10", markerfacecolor="white", zorder=-7)
plt.plot(x0_1[:nmax], q0_8[:nmax], "o", color="purple"     , markevery=20, markersize="10", markerfacecolor="white", zorder=-8)
# plt.plot(x0_1[:nmax], q0_9[:nmax], "o", color="orange"     , markevery=20, markersize="10", markerfacecolor="white", zorder=-7)
